...
class AgentConfig:
    """Configuration class for the LiveKit agent with Groq LLM support"""
    ...
    def __init__(self):
        ...
        # LLM Configuration - now supports both OpenAI and Groq
        self.llm_provider = os.getenv("LLM_PROVIDER", "openai")  # "openai" or "groq"
        ...
        self.groq_reasoning_effort = os.getenv("GROQ_REASONING_EFFORT", "medium")
    ...
    def get_llm_config(self):
        """Get LLM configuration as dict based on provider"""
